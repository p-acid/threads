...
export default function Login() {
  ...
  return (
    <View className="flex-1 items-center justify-center gap-3 bg-neutral-900 px-6">
      <Text className="mb-8 text-3xl font-bold text-white">반갑습니다!</Text>
      ...
      >
        <Text className="text-lg font-semibold text-black">로그인</Text>
      </TouchableOpacity>

      <View className="mt-4 flex-row items-center justify-center">
        <Text className="text-base text-white">계정이 없으신가요? </Text>
        <Link href="/sign-up" asChild>
          <Pressable>
            <Text className="font-medium text-blue-400">회원가입</Text>
          </Pressable>
        </Link>
      </View>
    </View>
